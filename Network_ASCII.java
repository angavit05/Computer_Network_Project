...
class Network_ASCII {
    ...
    public static void main(String[] args) {
        ...
        try {
            // Input validation for topology type
            System.out.print("Enter topology type (bus, ring, tree, mesh, hybrid, star): ");
            ...
            if (nodeNames.length != numNodes) {
                throw new IllegalArgumentException("Node names count does not match the specified number of nodes.");
            }
